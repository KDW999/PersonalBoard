        ...
        <Box>
          <Box sx = {{ display : 'flex'}}>
            ...
            <Box>
              ...
              <Typography sx = {{ mt : '2px', fontSize : '12px', fontWeight : 400, color : 'rgba(0, 0, 5, 0.7)'}}>{item.writeDate}</Typography>
            </Box>
          </Box>
         ...
         {item.img && (
          <Box>
            <Box component = 'img' src = {item.img} sx = {{ height : '152px', width : '152px', borderRadius : '5.0$'}}/>
          </Box>
         )}
      </CardActionArea>
   </Card>
